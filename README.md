...
* Needed dependencies for the example app: CMake (>=3.8.2, or 3.10.0-rc1 for VS2017), Boost system, filesystem, program_options (>=1.50.0), OpenCV core, imgproc, highgui (>=2.4.3).
